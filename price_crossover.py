...
'''
def sma_price_crossover(starting_capital, short_term_N, ticker, start_date, end_date, price_type='close'):

	print("")
	cprint("SMA Price Crossover:", attrs=['underline', 'bold'])
	...
	for date in date_range:
		...
		if short_term_sma > price:
			# If short_term > price - sell signal, as it is trending downwards
			if not liquid:
				liquid = True
