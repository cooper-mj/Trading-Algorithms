...
if __name__ == "__main__":
	...
	simple_sma_trade(1000, 30, 90, "HON", datetime(2015, 1, 25), datetime(2018, 8, 1))
	buy_and_hold(1000, "HON", datetime(2015, 1, 25), datetime(2018, 8, 1))
	stochastic_oscillator(1000, "HON", datetime(2015, 1, 25), datetime(2018, 8, 1), 14)
